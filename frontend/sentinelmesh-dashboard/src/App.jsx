...
function AppContent() {
  ...
  return (
    <div className="min-h-screen flex relative">
      ...
      {/* Main Content Area */}
      <div className={`flex-1 flex flex-col ${!isAuthPage ? (sidebarOpen ? 'ml-64' : 'ml-16') : ''} transition-all duration-300`}>
        {/* Header */}
        {!isAuthPage && (
          <header className="relative z-10 border-b border-border/50 bg-card/80 backdrop-blur-xl h-16">
            <div className="h-full px-6 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <ParticleText 
                  text="Welcome to SentinelMesh"
